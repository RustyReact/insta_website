        ...
        <div class="tab-pane form-horizontal" id="general_defaults">
          ...
          <div class="row-fluid">
            <div class="col-md-6">
              ...
              <div class="row form-group">
                <label class="col-md-3 form-control-label" for="purchase_order_prefix"><?php echo lang("purchase_order_prefix"); ?></label>
                <div class="col-md-9">
                  <?php echo form_input('purchase_order_prefix', $general->purchase_order_prefix, 'id="purchase_order_prefix" autocomplete="off" class="form-control" required="required"');?>
                </div>
              </div>
              <div class="row form-group">
                <label class="col-md-3 form-control-label" for="po_receiving_prefix"><?php echo lang("po_receiving_prefix"); ?></label>
                <div class="col-md-9">
                  <?php echo form_input('po_receiving_prefix', $general->po_receiving_prefix, 'id="po_receiving_prefix" autocomplete="off" class="form-control" required="required"');?>
                </div>
              </div>
              <div class="row form-group">
                <label class="col-md-3 form-control-label" for="payment_out_prefix"><?php echo lang("payment_out_prefix"); ?></label>
                <div class="col-md-9">
                  <?php echo form_input('payment_out_prefix', $general->payment_out_prefix, 'id="payment_out_prefix" autocomplete="off" class="form-control" required="required"');?>
                </div>
              </div>
            ...
            <div class="col-md-6">
              ...
              <div class="row form-group">
                <label class="col-md-3 form-control-label" for="next_purchase_order"><?php echo lang("next_purchase_order"); ?></label>
                <div class="col-md-9">
                  <?php echo form_input(array("name"=>"next_purchase_order", "type"=>"number", "value"=>$general->next_purchase_order, "id"=>"next_purchase_order", "class"=>"form-control", "step"=>"1", "min"=>"1")); ?>
                </div>
              </div>

              <div class="row form-group">
                <label class="col-md-3 form-control-label" for="next_po_receiving"><?php echo lang("next_po_receiving"); ?></label>
                <div class="col-md-9">
                  <?php echo form_input(array("name"=>"next_po_receiving", "type"=>"number", "value"=>$general->next_po_receiving, "id"=>"next_po_receiving", "class"=>"form-control", "step"=>"1", "min"=>"1")); ?>
                </div>
              </div>
              <div class="row form-group">
                <label class="col-md-3 form-control-label" for="next_payment_out"><?php echo lang("next_payment_out"); ?></label>
                <div class="col-md-9">
                  <?php echo form_input(array("name"=>"next_payment_out", "type"=>"number", "value"=>$general->next_payment_out, "id"=>"next_payment_out", "class"=>"form-control", "step"=>"1", "min"=>"1")); ?>
                </div>
              </div>
