...
<div id="default_content" style="display:none;">
  ...
  <hr><br><div class="row inv">
    ...
    <div class="col-sm-6">
      ...
      <b><?php echo "VAT Number" ?>:</b> xxxxx <b><?php echo "CR Number"?> </b><br>
    <b><?php echo lang("address") ?>:</b> 08 Rue Kahlalache Lakhdar Ain Lahdjar - Setif 19018 Algerie,<br></div>
    <div class="col-sm-6">
    <b><?php echo lang("phone") ?>:</b> +213778681799<br><b><?php echo lang("email") ?>:</b> bessemzitouni@gmail.com<br>
    <b>IBAN : </b> xxxxxxx<br>
        </div>
  ...
  <table class="table_invoice table_invoice-condensed table_invoice-striped" style="margin-bottom: 5px;">
    ...
    <tbody>
      ...
      <tr><td colspan="4" class="text-md-right font-weight-bold"><?php echo lang("vat_total"); ?></td><td class="text-md-right font-weight-bold">(17%) 239,87 $</td></tr>
