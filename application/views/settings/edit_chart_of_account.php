...
<h5 class="page-title"><?php echo lang('edit_user_account');?></h5>
...
<div class="row">
  <div class="col-md-10 col-md-offset-1">
    ...
    <div class="row form-group required">
      <label class="col-md-3 form-control-label " for="password"><?php echo lang('status');?></label>
      <div class="col-md-9">
        <select  name="status" value="" id="status" class="form-control">
          <option value="1" <?php if($account->status == 1){ echo "selected";} ?>> <?php echo lang('active');?></option>
          <option value="0" <?php if($account->status == 0){ echo "selected";} ?>> <?php echo lang('inactive');?></option>
        </select>
      </div>
    </div>
...
<div class="text-md-right">
  ...
  <?php echo form_submit('submit', lang('update'), array('class' => 'btn btn-primary'));?>
</div>
<?php echo form_close();?>
