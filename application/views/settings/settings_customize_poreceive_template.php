...
$margins      = explode(" ", $purchase_settings->margin);
$marginTop    = $margins[0];
$marginRight  = $margins[1];
$marginBottom = $margins[2];
$marginLeft   = $margins[3];
$selected_model = $purchase_settings->header_model;
echo form_open('/settings/customize_poreceive_template', 'class="customize_template" style=" margin: 0;"');
?>
    ...
    <div class="titlebar">
      <div class="row">
        ...
        <div class="col-md-12">
          <?php
          if( isset($create_new) ){
            echo form_input('template[name]', $purchase_settings->name, 'class="form-control"');
          }else{
            echo "<h4>".$purchase_settings->name."</h4>";
            echo form_hidden('template[name]', $purchase_settings->name);
          }
          ?>
        </div>
    ...
    <div class="card card-default m-a-0">
      ...
      <div class="card-block" style="display: none;">
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <?php
            $purchase_layouts = $this->settings_model->getPaperLayouts();
            echo form_dropdown('template[invoice_default_layout]', $purchase_layouts, $purchase_settings->purchase_default_layout, 'class="form-control" id="invoice_default_layout"');
            ?>
          </div>
        </div>
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <?php
            $purchase_size = $this->settings_model->getPaperSizes();
            echo form_dropdown('template[invoice_default_size]', $purchase_size, $purchase_settings->purchase_default_size, 'class="form-control" id="invoice_default_size"');
            ?>
          </div>
        </div>
        <div class="row form-group">
          <div class="col-md-8 col-md-offset-4">
            <label for="auto_print_check" style="line-height:30px;">
              <input type="checkbox" <?php if ($purchase_settings->auto_print == "1"): ?>checked="checked"<?php endif ?> id="auto_print_check"> <?php echo lang('auto_print') ?>
              <input type="hidden" name="template[auto_print]" value="<?php echo $purchase_settings->auto_print ?>" id="auto_print">
            </label>
          </div>
        </div>
      </div>
    ...
    <div class="card card-default m-a-0" style="margin-top: -2px !important;">
      ...
      <div class="card-block" style="display: none;">
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <?php echo form_dropdown('template[invoice_font]', $fonts_list, $purchase_settings->purchase_font, 'id="invoice_font" class="form-control"'); ?>
          </div>
        </div>
        <div class="row form-group">
          <label class="col-md-4 form-control-label" for="font_size"><?php echo lang('font_size') ?></label>
          <div class="col-md-8">
            <?php echo form_dropdown('template[font_size]', $fonts_sizes, $purchase_settings->font_size, 'id="font_size" class="form-control"'); ?>
          </div>
        </div>
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <div class="row">
              <input type="hidden" name="template[margin]" value="<?php echo $purchase_settings->margin; ?>" id="margin">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <?php echo form_input('template[text_color]', $purchase_settings->text_color, ' class="color form-control" autocomplete="off" title="'.lang('select_color').'" id="text_color"'); ?>
          </div>
        </div>
        <div class="row form-group">
          <label class="col-md-4 form-control-label" for="primary_color"><?php echo lang('primary_color') ?></label>
          <div class="col-md-8">
            <?php echo form_input('template[primary_color]', $purchase_settings->primary_color, ' class="color form-control" autocomplete="off" title="'.lang('select_color').'" id="primary_color"'); ?>
          </div>
        </div>
        ...
        <div class="row form-group" style="margin-bottom: 10px;">
          <div class="col-md-8 col-md-offset-4">
            <label for="table_border_check" style="line-height:30px;">
              <input type="checkbox" <?php if ($purchase_settings->table_border == "1"): ?>checked="checked"<?php endif ?> id="table_border_check"> <?php echo lang('bordered') ?>
              <input type="hidden" name="template[table_border]" value="<?php echo $purchase_settings->table_border ?>" id="table_border">
            </label>
          </div>
        </div>
        <div class="row form-group">
          <div class="col-md-8 col-md-offset-4">
            <label for="table_strip_check" style="line-height:30px;">
              <input type="checkbox" <?php if ($purchase_settings->table_strip == "1"): ?>checked="checked"<?php endif ?> id="table_strip_check"> <?php echo lang('striped') ?>
              <input type="hidden" name="template[table_strip]" value="<?php echo $purchase_settings->table_strip ?>" id="table_strip">
            </label>
          </div>
        </div>
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <input type="number" name="template[table_line_th_height]" value="<?php echo $purchase_settings->table_line_th_height ?>" id="table_line_th_height" class="form-control" step="1" min="0" max="65" >
          </div>
        </div>
        <div class="row form-group">
          <label class="col-md-4 form-control-label" for="table_line_td_height"><?php echo lang('line_td_height') ?></label>
          <div class="col-md-8">
            <input type="number" name="template[table_line_td_height]" value="<?php echo $purchase_settings->table_line_td_height ?>" id="table_line_td_height" class="form-control" step="1" min="0" max="65" >
          </div>
        </div>
        <div class="row form-group">
          <label class="col-md-4 form-control-label" for="table_line_th_bg"><?php echo lang('line_th_bg') ?></label>
          <div class="col-md-8">
            <?php echo form_input('template[table_line_th_bg]', $purchase_settings->table_line_th_bg, ' class="color form-control" autocomplete="off" title="'.lang('select_color').'" id="table_line_th_bg"'); ?>
          </div>
        </div>
        <div class="row form-group">
          <label class="col-md-4 form-control-label" for="table_line_th_color"><?php echo lang('line_th_color') ?></label>
          <div class="col-md-8">
            <?php echo form_input('template[table_line_th_color]', $purchase_settings->table_line_th_color, ' class="color form-control" autocomplete="off" title="'.lang('select_color').'" id="table_line_th_color"'); ?>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card card-default m-a-0" style="margin-top: -2px !important;">
      ...
      <div class="card-block" style="display: none;">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <?php echo form_dropdown('template[logo_size]', $logo_sizes, $purchase_settings->logo_size, 'id="logo_size" class="form-control"'); ?>
          </div>
        </div>
        <div class="row form-group" style="margin-bottom: 10px;">
          <div class="col-md-8 col-md-offset-4">
            <label for="logo_monocolor_check" style="line-height:30px;">
              <input type="checkbox" <?php if ($purchase_settings->logo_monocolor == "1"): ?>checked="checked"<?php endif ?> id="logo_monocolor_check"> <?php echo lang('monocolor') ?>
              <input type="hidden" name="template[logo_monocolor]" value="<?php echo $purchase_settings->logo_monocolor ?>" id="logo_monocolor">
            </label>
          </div>
        </div>
        <div class="row form-group">
          <div class="col-md-8 col-md-offset-4">
            <label for="logo_greyscale_check" style="line-height:30px;">
              <input type="checkbox" <?php if ($purchase_settings->logo_greyscale == "1"): ?>checked="checked"<?php endif ?> id="logo_greyscale_check"> <?php echo lang('grayscale') ?>
              <input type="hidden" name="template[logo_greyscale]" value="<?php echo $purchase_settings->logo_greyscale ?>" id="logo_greyscale">
            </label>
          </div>
        </div>
      </div>
    ...
    <div class="card card-default m-a-0" style="margin-top: -2px !important;">
      ...
      <div class="card-block" style="display: none;">
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <?php echo form_input('template[background_color]', $purchase_settings->background_color, ' class="color form-control":"form-control hover_tip" autocomplete="off" title="'.lang('select_color').'" id="background_color"'); ?>
          </div>
        </div>
        <div class="row form-group">
          ...
          <div class="col-md-12">
            ...
            <input type="hidden" name="template[background_image]" id="background_image" value="<?php echo $purchase_settings->background_image ?>" />
          </div>
        </div>
        <div id="background_image_div" <?php echo trim($purchase_settings->background_image)==""?"style=\"display:none;\"":""; ?>>
          <div class="row form-group">
            ...
            <div class="col-md-8">
              ...
              <img  id="background_image_thumb" src="<?php echo base_url($purchase_settings->background_image) ?>" class="img-thumbnail">
            </div>
          </div>
          <div class="row form-group">
            <label class="col-md-4 form-control-label"><?php echo $this->lang->line('position') ?></label>
            <div class="col-md-8">
              <input type="hidden" name="template[background_position]" id="background_position" value="<?php echo $purchase_settings->background_position; ?>">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-8">
              <input type="hidden" name="template[background_fit]" id="background_fit" value="<?php echo $purchase_settings->background_fit; ?>">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-8">
              <input type="number" name="template[background_opacity]" id="background_opacity" min="0" max="1" step="0.1" value="<?php echo floatval($purchase_settings->background_opacity); ?>" class="form-control" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="card card-default m-a-0" style="margin-top: -2px !important;">
      ...
      <div class="card-block" style="display: none;">
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <label for="show_header_check" style="line-height:30px;">
              <input type="checkbox" <?php if ($purchase_settings->show_header == "1"): ?>checked="checked"<?php endif ?> id="show_header_check"> <?php echo lang('show_header') ?>
              <input type="hidden" name="template[show_header]" value="<?php echo $purchase_settings->show_header ?>" id="show_header_hidden">
            </label>
          </div>
        </div>
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <?php echo form_input('template[header_bg_color]', $purchase_settings->header_bg_color, ' class="color form-control col-md-10":"form-control col-md-4 hover_tip" title="'.lang('header_bg_color').'" autocomplete="off" id="header_bg_color"'); ?>
          </div>
        </div>
        <div class="row form-group">
          <label class="col-md-4 form-control-label"><?php echo lang('txt_color') ?></label>
          <div class="col-md-8">
            <?php echo form_input('template[header_txt_color]', $purchase_settings->header_txt_color, ' class="color form-control col-md-10":"form-control col-md-4 hover_tip" title="'.lang('header_txt_color').'" autocomplete="off" id="header_txt_color"'); ?>
          </div>
        </div>
        <div class="row form-group">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-12">
            <textarea name="template[header_text]" id="editor_header_text"><?php echo $purchase_settings->header_text ?></textarea>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <label for="show_footer_check" style="line-height:30px;">
              <input type="checkbox" <?php if ($purchase_settings->show_footer == "1"): ?>checked="checked"<?php endif ?> id="show_footer_check"> <?php echo lang('show_footer') ?>
              <input type="hidden" name="template[show_footer]" value="<?php echo $purchase_settings->show_footer ?>" id="show_footer">
            </label>
          </div>
        </div>
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <?php echo form_input('template[footer_bg_color]', $purchase_settings->footer_bg_color, ' class="color form-control col-md-10":"form-control col-md-4 hover_tip" title="'.lang('footer_bg_color').'" autocomplete="off" id="footer_bg_color"'); ?>
          </div>
        </div>
        <div class="row form-group">
          <label class="col-md-4 form-control-label required" for="footer_txt_color"><?php echo lang('txt_color') ?></label>
          <div class="col-md-8">
            <?php echo form_input('template[footer_txt_color]', $purchase_settings->footer_txt_color, ' class="color form-control col-md-10":"form-control col-md-4 hover_tip" title="'.lang('footer_txt_color').'" autocomplete="off" id="footer_txt_color"'); ?>
          </div>
        </div>
        <div class="row form-group">
          <label class="col-md-4 form-control-label" for="editor_footer_text"><?php echo lang('footer_text') ?></label>
          <div class="col-md-12">
            <textarea name="template[footer_text]" id="editor_footer_text"><?php echo $purchase_settings->footer_text ?></textarea>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <label for="show_signature_check" style="line-height:30px;">
              <input type="checkbox" <?php if ($purchase_settings->show_signature == "1"): ?>checked="checked"<?php endif ?> id="show_signature_check"> <?php echo lang('show_footer') ?>
              <input type="hidden" name="template[show_signature]" value="<?php echo $purchase_settings->show_signature ?>" id="show_signature">
            </label>
          </div>
        </div>
        <div class="row form-group">
          ...
          <div class="col-md-8">
            <?php echo form_input('template[signature_txt]', $purchase_settings->signature_txt, ' class="form-control col-md-10":"form-control col-md-4 hover_tip" title="'.lang('signature_txt').'" autocomplete="off" id="signature_txt"'); ?>
          </div>
        </div>
        <div class="row form-group">
          ...
          <div class="col-md-12">
            ...
            <input type="hidden" name="template[signature_stamp]" id="signature_stamp" value="<?php echo $purchase_settings->signature_stamp ?>" />
          </div>
        </div>
        <div class="row form-group" id="signature_stamp_preview" <?php echo trim($purchase_settings->signature_stamp)==""?"style=\"display:none;\"":""; ?>>
          <label class="col-md-4 form-control-label"><?php echo $this->lang->line('preview') ?></label>
          <div class="col-md-8">
            ...
            <img  id="signature_stamp_thumb" src="<?php echo base_url($purchase_settings->signature_stamp) ?>" class="img-thumbnail">
          </div>
        </div>
      </div>
    </div>
...
$(function() {
  ...
  $.fn.refreshPreviewTemplateAjax = function(){
    ...
    $.ajax({
      url: SITE_URL+'/settings/purchase_template',
      data : adata,
      async: false,
      type: 'POST',
      beforeSend: function(){
...
<div id="default_content" style="display:none;">
  <div class="row text-md-center">
    <div class="col-sm-3">
      <h3 class="inv col"><b><?php echo lang("purchase_no"); ?></b><br>0010</h3>
    </div>
    <div class="col-sm-3">
      <h3 class="inv col"><b><?php echo lang("reference"); ?></b><br>PO-170010</h3>
    </div>
    <div class="col-sm-3">
  ...
  <br><h3 class="inv"><?php echo lang("purchase_items"); ?></h3>
  <table class="table_invoice table_invoice-condensed table_invoice-striped" style="margin-bottom: 5px;">
    <thead>
      <tr>
        <th><?php echo lang("n°"); ?></th>
        <th><?php echo lang("item_description"); ?> (<?php echo lang("code"); ?>)</th>
        <th><?php echo lang("uom"); ?></th>
        <th><?php echo lang("invoiced_qty"); ?></th>
        <th><?php echo lang("unit_price"); ?></th>
        <th><?php echo lang("invoice_value"); ?></th>
        <th><?php echo lang("vat_value"); ?></th>
        <th><?php echo lang("received_qty"); ?></th>
        <th><?php echo lang("received_value"); ?></th>
      </tr>
    </thead>
    <tbody>
      <tr><td class="text-md-center">1</td><td class="text-md-left">Sony vaio (Pc Portable)</td><td class="text-md-center">2.00</td><td class="text-md-center">500,00 $</td><td class="text-md-center">1 000,00 $</td><td class="text-md-center">900,00 $</td><td class="text-md-center">323,00 $</td><td class="text-md-center">563,00 $</td><td class="text-md-center">123,00 $</td></tr>
      <tr><td class="text-md-center">2</td><td class="text-md-left">Wireless Alfa + Decoder</td><td class="text-md-center">1.00</td><td class="text-md-center">320,00 $</td><td class="text-md-center">320,00 $</td><td class="text-md-center">320,00 $</td><td class="text-md-center">360,00 $</td><td class="text-md-center">70,00 $</td><td class="text-md-center">220,00 $</td></tr>
      <tr><td class="text-md-center">3</td><td class="text-md-left">Flash disk</td><td class="text-md-center">5.00</td><td class="text-md-center">1,20 $</td><td class="text-md-center">6,00 $</td><td class="text-md-center">6,00 $</td><td class="text-md-center">6,00 $</td><td class="text-md-center">6,00 $</td><td class="text-md-center">6,00 $</td></tr>
      <tr><td class="text-md-center">4</td><td class="text-md-left">SkyWifi</td><td class="text-md-center">1.00</td><td class="text-md-center">35,00 $</td><td class="text-md-center">35,00 $</td><td class="text-md-center">35,00 $</td><td class="text-md-center">35,00 $</td><td class="text-md-center">35,00 $</td><td class="text-md-center">35,00 $</td></tr>
      <tr><td class="text-md-center">5</td><td class="text-md-left">Aduino</td><td class="text-md-center">10.00</td><td class="text-md-center">5,00 $</td><td class="text-md-center">50,00 $</td><td class="text-md-center">50,00 $</td><td class="text-md-center">50,00 $</td><td class="text-md-center">50,00 $</td><td class="text-md-center">50,00 $</td></tr>
      <tr><td colspan="8" class="text-md-right font-weight-bold"><?php echo lang("subtotal"); ?></td><td class="text-md-right font-weight-bold">1 411,00 $</td></tr>
      <tr><td colspan="8" class="text-md-right font-weight-bold"><?php echo lang("total"); ?></td><td class="text-md-right font-weight-bold">1 650,87 $</td></tr>
    </tbody>
  </table>
  <div class="col-sm-12">
