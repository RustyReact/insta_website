...
class Settings_model extends CI_Model
{
    ...
    public $DEFAULT_SETTINGS = array(
        "SYSTEM" => array(
            ...
            "exchange_api_key" => "",
            "purchase_receipt_next" => 1,
            "purchase_order_prefix" =>"PO-",
            "next_purchase_order" => 1,
            "po_receiving_prefix" => "REC-",
            "next_po_receiving"=>1,
            "payment_out_prefix" =>"PYMT-",
            "next_payment_out"=>1
        ),
        "INVOICE" => array(
            "name"                   => "Default",
            ...
            "header_text"            => "<h4>[company_name]</h4><p>[company_address], [company_city], [company_postal_code] [company_state], [company_country] <br><b>VAT:</b> [company_vat]<b> CR Number:</b> [company_cr] <br><b>Phone:</b> [company_phone]  <b><br>Email: </b>[company_email] <b> <br>IBAN: </b>[company_iban]</p>",
            "show_header"            => 1,
            "show_footer"            => 1,
        ...
        "PURCHASE" => array(
            "name"                   => "Grayscale",
            "primary_color"          => "#009be1",
            "purchase_font"           => "Arial, Helvetica, sans-serif",
            "purchase_default_layout" => "portrait",
            "purchase_default_size"   => "A4",
            "header_model"           => "model1",
            "header_bg_color"        => "#ffffff",
            "header_txt_color"       => "#000000",
        ...
        "PORECEIVE" => array(
            ...
            "primary_color"          => "#009be1",
            "purchase_font"           => "Arial, Helvetica, sans-serif",
            "purchase_default_layout" => "landscape",
            "purchase_default_size"   => "A4",
            "header_model"           => "model1",
            "header_bg_color"        => "#ffffff",
            "header_txt_color"       => "#000000",
        ...
        "COMPANY" => array(
            ...
            "postal_code"         => "120258",
            "country"             => "Romania",
            "phone"               => "011 40 999999999",
            "email"               => "malexandrescu@outlook.com",
    ...
    public function __construct ()
    {
        ...
        $this->PO_Settings   = $this->getSettings ("PURCHASE");
        ...
        */
        ...
        define("PURCHASE_PREFIX", $this->SYS_Settings->purchase_order_prefix);
    ...
    public function getGLstatusInvoice($id = false)
    {
    
        $array = array(
            "not_posted"   => lang("not_posted"),
            "posted"  => lang("posted"),
        );
    ...
    public function getGLstatus($id = false)
    {
    ...
    public function getSettings ($type =  "SYSTEM")
    {
        ...
        $array = array_merge($DF_SETTINGS, $DB_SETTINGS);
